    ...
    <main>
      ...
      <section id="intro">
        ...
        <p>
          ...
          world around us works. I am willing to learn and develop new skills.
        </p>
      </section>
      ...
      <section id="work">
        ...
        <div class="experience">
          ...
          <p class="experienceInfo">
            ...
            of PhD students to demonstrate and suggested that final year
            students could fill the gap. I am extremely proud as this model was
            such a success that it has been duplicated this year, with a second
        ...
        <div class="experience">
          ...
          <p class="experienceInfo">
            ...
            translates python to C and vice versa). We also had to figure how to
            include Arduinos into some of the second-year projects. I went from
            not having much experience at all with Arduinos to building circuits
            for data collection from a sensor. We also researched and gained an
            understanding of how other departments use Arduinos or how they
        ...
        <table>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <ul>
                  ...
                  <li>
                    Summer Placement - Developed using Firmata to control an
                    Arduino
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>Second year of university</li>
                  <li>Summer Placement - developed in the Arduino IDE</li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  <li>Online course ‘MATLAB fundamentals’</li>
                </ul>
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>Passed my test in March 2018</li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    Summer placement – talking to lectures about how their
                    departments use Arduinos or would want to incorporate
                    Arduinos in the future
                  </li>
                  <li>
                    Experiments – communicating with my team to see if we were
                    all on track
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    Summer placement – which best components to use and how to
                    build a circuit to collect data
                  </li>
                  <li>
                    Experiments – figure out how to complete our brief with data
                    collected
                  </li>
                </ul>
              </td>
            ...
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    Summer Placement – we had a month to finish all the tasks
                    given to us, and a free range so time management was key
                  </li>
                  <li>Experiments – we had a semester to finish the project</li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  <li>Summer Placement - working with a partner</li>
                  <li>
                    Experiments - working with a team in the laboratory sessions
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    Summer placement – sometimes the manager would think of new
                    ideas for us to try out so we would have to change direction
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  <li>
                    Demonstrating - Simplifying and concise explanation for
                    students
                  </li>
                </ul>
              </td>
            ...
            <tr>
              <td>Presentation and organisation</td>
              <td>
                <ul>
                  <li>
                    Summer placement – writing a summary and conclusion for all
                    the discoveries we had made
                  </li>
                </ul>
              </td>
            </tr>
            <tr>
              ...
              <td>
                <ul>
                  <li>Experiments - Project managing a team</li>
                </ul>
              </td>
            </tr>
          </tbody>
      ...
      <section id="interests">
        ...
        <p>
          ...
          mentally and physically fit. I often go walking outdoors especially
          with my dog. I enjoy being creative and innovative and express it in
          my art. I also hold an UK driving licence.
        </p>
      </section>
    </main>
  );
